...
int main() {
    ...
    while (running) {
        ...
        //Collision checker for top side of block;
        for (int a = 0; a < l; a++) {
                    ...
                    case SDLK_SPACE:
                        for (int a = 0; a < l; a++) {
                            if (Player.form.y <= objects[a].form.y + objects[a].form.h
                                ...
                                for (i = 0; i < max; i++) {
                                    if (i >= 0 && i <= (max / 100) * 25) {
                                        Player.form.y = Player.form.y - 4;
                                    } else if (i >= 2 && i <= (max / 100) * 50) {
                                        Player.form.y = Player.form.y - 3;
                                    } else if (i >= 3 && i <= (max / 100) * 75) {
                                        Player.form.y = Player.form.y - 2;
                                    } else if (i >= 4 && i <= max) {
                                        Player.form.y = Player.form.y - 1;
                                    }
                                }
